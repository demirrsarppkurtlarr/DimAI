"""Seed corpus: Python code snippets for training our own model. No external AI APIs."""
...
def main() -> None:
    ...
    print(f"Wrote {out} ({len(text)} chars, {len(SNIPPETS)} snippets)")
