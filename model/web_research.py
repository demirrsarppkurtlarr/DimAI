...
def _clean_query(text: str) -> str:
    ...
    tech_map = {
        ...
        "embedding": "word embedding vector representation",
        "transformer": "transformer neural network architecture",
        "helm": "Helm Kubernetes package manager",
        "argocd": "Argo CD GitOps Kubernetes",
        "vite": "Vite frontend build tool",
        "zustand": "Zustand React state",
        ...
        "circuit breaker": "circuit breaker software pattern",
        "feature flag": "feature flag feature toggle",
        "blue green": "blue-green deployment",
        "canary": "canary release deployment",
        ...
        "deadlock": "deadlock computer science concurrency",
        "race condition": "race condition concurrency",
        "memory leak": "memory leak software",
        "garbage collection": "garbage collection memory management",
        ...
        "observability": "observability software systems",
